...
# 2nd Plot
with (plot_base, plot(Time, Sub_metering_1, type="l", xlab="", ylab="Energy sub metering"))
...
legend("topright", legend=leg_text, col = leg_col, bty = "n",lty = 1)

# 3rd Plot
with(plot_base, plot(Time, Voltage, type="l", xlab="datetime", ylab="Voltage"))

# 4rth Plot
with(plot_base, plot(Time, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
